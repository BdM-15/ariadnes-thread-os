...
id: global-concept-match_lens
last_updated: 2026-06-08
name: "Match lens (future)"
...
Vision pair: suitability (% of expiring work matching your BU capabilities) and synergy (% where another BU enables teaming). Activates when capability profiles live in vault.

## In the app

Market Overview → Future Funding → Match Lens (Future)
