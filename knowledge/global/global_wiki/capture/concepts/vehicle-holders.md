...
id: global-concept-vehicle_holders
...
Prime that receives the most dollars on a given contract vehicle (IDIQ, BPA, etc.). Teaming target if you lack schedule position; competitive intel if you plan to displace.
